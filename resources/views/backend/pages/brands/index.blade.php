    ...
    <section class="mb-1">
        <div class="col-12">
            ...
            <div class="col-12 top_btn">
                <div class="btn-group">
                    <button class="btn btn-outline-primary" data-toggle="modal" data-target="#brand"><span><i class="feather icon-plus"></i>&nbsp; Add New</span></button>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel17">Add New Brand</h4>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <label for="first-name-vertical">Brand Description</label>
