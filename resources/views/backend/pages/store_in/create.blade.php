    ...
    <section class="mb-1">
        <div class="col-12">
            ...
            <div class="col-12 top_btn">
                <div class="btn-group">
                    <a href="{{route('store_in.index')}}" class="btn btn-outline-primary"><span><i class="feather icon-list"></i>&nbsp;List All</span></a>
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="date" class="form-control" name="store_in_date">
                                            </div>
                                            <div class="form-group">
                                                <label for="supplier_invoice_number">Invoice Number (optional)</label>
                                                <input type="text" id="supplier_invoice_number" class="form-control" name="supplier_invoice_number" placeholder="if have any supplier invoice number">
                                            </div>
                                            <div class="form-group">
                                                <label for="invoice_document">Upload invoice document (optional)</label>
                                                <input type="file" id="unit_id" class="form-control" name="invoice_document" placeholder="if have any document">
                                            </div>
                                            <div class="form-group">
                                                <label for="supplier_name">Supplier name</label>
                                                <input type="text" id="supplier_name" class="form-control" name="supplier_name" placeholder="Supplier Name">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="supplier_name">Grand Total</label>
                                                <input type="number" id="supplier_name" class="form-control" name="supplier_name" placeholder="Grand Total" readonly>
                                            </div>
                                            <div class="form-group">
    ...
    <script>
        $( document ).ready(function() {
            ...
            function appendRow(){
                ...
                <td>\
                    <input type="number" id="total_price" readonly class="form-control" name="total_price" placeholder="Total Price">\
                </td>\
                <td>\
